  ...
  return (
    ...
    >
      ...
      <div className="flex items-center">
        <img
          src="https://ochaka.vercel.app/images/logo/logo.svg"
          alt="Logo"
      ...
      <div className="hidden md:block">
        {" "}
        <a href="contact">
          <button className="bg-black font-semibold px-6 py-3 shadow-md hover: text-white  hover:bg-black focus:outline-none focus:ring-0 cursor-pointer">
            Book Appointment
          </button>
        </a>
      </div>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md md:hidden z-10">
          <ul className="flex flex-col space-y-4 px-6 py-4 text-base font-semibold">
            ...
            <li>
              <a href="/contact">
                <button className="bg-gradient-to-r bg-black text-white font-semibold px-6 py-3 w-full shadow-md hover:scale-105 transition-transform cursor-pointer">
                  Book Appointment
                </button>
              </a>
            </li>
